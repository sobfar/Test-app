...
(function (global) {
  ...
  const PRODUCTS = {
    remove_ads: {
      id: "remove_ads",
      title: "حذف همیشگی تبلیغات",
      desc: "برای همیشه بدون تبلیغ بازی کن!",
      price: "۱۵,۰۰۰ تومان",
      type: "non_consumable",
      badge: "محبوب‌ترین",
    },
    hint_pack_5: {
      ...
      desc: "وقتی گیر کردی، راهنمایی در اختیارت!",
      price: "۵,۰۰۰ تومان",
      originalPrice: "۶,۰۰۰",
      discount: "۲۰٪ تخفیف",
      type: "consumable",
    ...
    hint_pack_20: {
      ...
      desc: "بسته‌ی پیشنهادی و پرطرفدار!",
      price: "۱۵,۰۰۰ تومان",
      originalPrice: "۲۲,۰۰۰",
      discount: "۳۳٪ تخفیف",
      type: "consumable",
      qty: 20,
    },
    hint_pack_100: {
      id: "hint_pack_100",
      title: "۱۰۰ راهنمای اضافه",
      desc: "دیگه هیچ مرحله‌ای نمی‌تونه متوقفت کنه!",
      price: "۴۲,۰۰۰ تومان",
      originalPrice: "۷۰,۰۰۰",
      discount: "۴۰٪ تخفیف",
      type: "consumable",
      qty: 100,
    },
    bundle_gold: {
      id: "bundle_gold",
      title: "بسته طلایی",
      desc: "همه چیز برای یک تجربه‌ی عالی!",
      price: "۴۹,۰۰۰ تومان",
      originalPrice: "۹۰,۰۰۰",
      discount: "۴۵٪ تخفیف",
      type: "bundle",
      qty: 50,
      badge: "بهترین انتخاب",
